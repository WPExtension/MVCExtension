 ...
 */
 ...
 if( !function_exists('initMVCExtension') ) {
  ...
  initMVCExtension();
   ...
   $PACKAGE_DIR = [
     'APPLICATION_PASSWORD' =>  'package-plugins/application-passwords/class.application-passwords.php',
     'JWT_AUTHENTICATION' =>  'package-plugins/jwt-authentication-for-wp-rest-api/jwt-auth.php',
     'CMB2' => 'package-plugins/cmb2/init.php',	
   ];
